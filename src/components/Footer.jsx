...
const Footer = () => {
  return (
    <footer className=" xl:px-[75px] lg:px-[45px] bg-[#0d0c0f] border border-[#ffffff1a]  md:px-[30px] px-5  md:pt-10 pt-[25px] lg:pt-[70px] mt-auto lg:pb-10 md:pb-[30px] pb-5 lg:gap-[60px] gap-5 md:gap-10 flex flex-col">
      {/* Top info */}
